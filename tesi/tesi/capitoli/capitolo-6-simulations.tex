...
%		todo commento
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1.0\textwidth]{immagini/la-25/b0/j0/fnr}
		\includegraphics[width=1.0\textwidth]{immagini/la-25/b0/j1/fnr}
		\includegraphics[width=1.0\textwidth]{immagini/la-25/b1/j0/fnr}
		\includegraphics[width=1.0\textwidth]{immagini/la-25/b1/j1/fnr}
		\caption{\textit{FNR} for Los Angeles urban scenario}
		\label{fig:la-25-fnr}
	\end{figure}
