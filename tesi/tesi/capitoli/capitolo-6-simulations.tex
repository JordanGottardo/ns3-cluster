...
\chapter{Simulations}
	...
	\section{Padua urban scenario}
		...
		The same observations hold true even for \textit{TDROC} (\Figure{fig:padua-25-tdr}). Hence, the benefits of junctions are twofold even for this scenario regarding delivery ratios.
