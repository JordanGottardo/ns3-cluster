	...
	\section{Hello Message forging scenario}
		\subsection{Low severity attack}
				...
				\begin{tabularx}{\textwidth}{l | l  l}
					...
					Source of alert message position		& Center				&		\\
					Mobility model							& ns3::ConstantPosition	&		\\
					Vehicles reached by forging				& 0, 10, 20, 30, 40, 50 & \%	\\
					Number of forged messages				& 100					&		\\
					Forged distances						& 300, 301,...,400			&		\\
					\midrule[1pt]
					\rowcolor{P} \multicolumn{3}{c}{Network configuration} \\
					\midrule[1pt]
					...
					\bottomrule
				\end{tabularx}
				\caption{Low severity forging attack scenario configuration}
		...
		\subsection{High severity attack}
			\begin{table}[H]
				...
				\begin{tabularx}{\textwidth}{l | l  l}
					...
					\bottomrule
				\end{tabularx}
				\caption{High severity forging attack scenario configuration}
