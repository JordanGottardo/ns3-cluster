...
%**************************************************************
\mainmatter
\input{capitoli/capitolo-1-introduction}  
\input{capitoli/capitolo-2-models}  
\input{capitoli/capitolo-3-fast-broadcast}         
\input{capitoli/capitolo-4-roff}      
\input{capitoli/capitolo-5-tools-and-applications}            
\input{capitoli/capitolo-6-simulations}         
\input{capitoli/capitolo-7-conclusions}           
...
\appendix
\input{capitoli/appendice-A-fast-broadcast}    
%**************************************************************
% Materiale finale
%**************************************************************
\backmatter
